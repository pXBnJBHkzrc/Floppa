...
--			Main-- -- --=-- -- --Color3.fromRGB(25,-- -- --25,-- -- --25),
	--		Second-- -- --=-- -- --Color3.fromRGB(32,-- -- --32,-- -- --32),			Stroke-- -- --=-- -- --Color3.fromRGB(60,-- -- --60,-- -- --60),			Text-- -- --=-- -- --Color3.fromRGB(240,-- -- --240,-- -- --240),TextDark-- -- --=-- -- --Color3.fromRGB(150,-- -- --150,-- -- --150)
--		}
--	},
--
--
...
--
--
--	endend-- -- ---- -- ---- -- --local-- -- --Orion-- -- --=-- -- --Instance.new("ScreenGui").Name-- -- --=-- -- --"Orion"if-- -- --syn-- -- --thenif-- -- --gethui-- -- --then	for-- -- --_,-- -- --Interface-- -- --in-- -- --ipairs(gethui():GetChildren())-- -- --do
--
--
...
--
--
--	endelse	for-- -- --_,-- -- --Interface-- -- --in-- -- --ipairs(game.CoreGui:GetChildren())-- -- --do		if-- -- --Interface.Name-- -- --==-- -- --Orion.Name-- -- --and-- -- --Interface-- -- --~=-- -- --Orion-- -- --thennterface:Destroy()
--		end
--
--	end
--
...
--en--d-- -- ---- -- ---- -- ---- -- --
--
--lo--cal-- -- --function-- -- --Create(Name,-- -- --Properties,-- -- --Children)
...
--en--d
--
--lo--cal-- -- --function-- -- --CreateElement(ElementName,-- -- --ElementFunction)
--	OrionLib.Elements[ElementName]-- -- --=-- -- --function(...)
--		return-- -- --ElementFunction(...)
--	end
--e--n--d
--
--lo--cal-- -- --function-- -- --MakeElement(ElementName,-- -- --...)
--	local-- -- --NewElement-- -- --=-- -- --OrionLib.Elements[ElementName](...)
--	return-- -- --NewElement
--en--d
--
--lo--cal-- -- --function-- -- --SetProps(Element,-- -- --Props)
...
--end
----
--l--ocal-- -- --function-- -- --SetChildren(Element,-- -- --Children)
...
--					OrionLib.Flags[a]:Set(UnpackColor(b))				else					OrionLib.Flags[a]:Set(b)				end-- -- ---- -- ---- -- ---- -- --			end)		else	end)
--
--
--end
--
...
--end)
--
--C--reateElement("List",-- -- --function(Scale,-- -- --Offset)
...
--end)
--
--Cr--eateElement("Frame",-- -- --function(Color)
...
--en--d)
--
--Cr--eateElement("RoundFrame",-- -- --function(Color,-- -- --Scale,-- -- --Offset)
--	local-- -- --Frame-- -- --=-- -- --Create("Frame",-- -- --{
--		BackgroundColor3-- -- --=-- -- --Color-- -- --or-- -- --Color3.fromRGB(255,-- -- --255,-- -- --255),
--		BorderSizePixel-- -- --=-- -- --0
--	},-- -- --{
...
--end)--
--
--Cr----eateElement("Button",-- -- --function()
...
--Create--Element("ScrollFrame",-- -- --function(Color,-- -- --Width)
	--local-- -- --ScrollFrame-- -- --=-- -- --Create("ScrollingFrame",-- -- --{
	--	BackgroundTransparency-- -- --=-- -- --1,
	--	MidImage-- -- --=-- -- --"rbxassetid://7733746798",
	--	BottomImage-- -- --=-- -- --"rbxassetid://7733746798",
	--	TopImage-- -- --=-- -- --"rbxassetid://7733746798",
...
--	WindowConfig.Icon-- -- --=-- -- --WindowConfig.Icon-- -- --or-- -- --"rbxassetid://7733746798"
--	WindowConfig.IntroIcon-- -- --=-- -- --WindowConfig.IntroIcon-- -- --or-- -- --"rbxassetid://7733746798"
...
--
--1				local-- -- --Slider-- -- --=-- -- --{Value-- -- --=-- -- --SliderConfig.Default,-- -- --Save-- -- --=-- -- --SliderConfig.Save}
...
Teleports:AddDropdown({
    ...
    Default = "",
    Options = { "Caldera Spawn", "Ruins Spawn (Sand Town)", "Westwood Spawn", "Blades Sactuary", "Yar'thul Gate",
        "Thorian Gate", },
    Callback = function(Value)
        ...
        elseif Value == "Thorian Gate" then
            ...
            local tween = game:GetService("TweenService"):Create(lp.Character.HumanoidRootPart,
                TweenInfo.new(Time), { CFrame = CFrameEnd })
            tween:Play()
        elseif Value == "Blades Sactuary" then
...
--
--
--				Size-- -- --=-- -- --UDim2.new(1,-- -- --0,-- -- --1,-- -- --0),				Parent-- -- --=-- -- --ItemParent			}),-- -- --{				AddThemeObject(SetProps(MakeElement("Image",-- -- --"rbxassetid://3610239960"),-- -- --{					Size-- -- --=-- -- --UDim2.new(0,-- -- --18,-- -- --0,-- -- --18),Position-- -- --=-- -- --UDim2.new(0,-- -- --15,-- -- --0,-- -- --15),
--
--
--					ImageTransparency-- -- --=-- -- --0.4				}),-- -- --"Text"),
--
--
--				AddThemeObject(SetProps(MakeElement("Label",-- -- --"Unauthorised-- -- --Access",-- -- --14),-- -- --{					Size-- -- --=-- -- --UDim2.new(1,-- -- ---38,-- -- --0,-- -- --14),					Position-- -- --=-- -- --UDim2.new(0,-- -- --38,-- -- --0,-- -- --18),					TextTransparency-- -- --=-- -- --0.4				}),-- -- --"Text"),				AddThemeObject(SetProps(MakeElement("Image",-- -- --"rbxassetid://4483345875"),-- -- --{					Size-- -- --=-- -- --UDim2.new(0,-- -- --56,-- -- --0,-- -- --56),					Position-- -- --=-- -- --UDim2.new(0,-- -- --84,-- -- --0,-- -- --110),
--
--
--				}),-- -- --"Text"),				AddThemeObject(SetProps(MakeElement("Label",-- -- --"Premium-- -- --Features",-- -- --14),-- -- --{					Size-- -- --=-- -- --UDim2.new(1,-- -- ---150,-- -- --0,-- -- --14),
--
--
...
--
--
--					Font-- -- --=-- -- --Enum.Font.GothamBold				}),-- -- --"Text")				AddThemeObject(SetProps(MakeElement("Label",-- -- --"This-- -- --part-- -- --of-- -- --the-- -- --script-- -- --is-- -- --locked-- -- --to-- -- --Sirius-- -- --Premium-- -- --users.-- -- --Purchase-- -- --Premium-- -- --in-- -- --the-- -- --Discord-- -- --server-- -- --(discord.gg/sirius)",-- -- --12),-- -- --{
--
--
--					Size-- -- --=-- -- --UDim2.new(1,-- -- ---200,-- -- --0,-- -- --14),					Position-- -- --=-- -- --UDim2.new(0,-- -- --150,-- -- --0,-- -- --138),					TextWrapped-- -- --=-- -- --true,
--
--
--
--
--					TextTransparency-- -- --=-- -- --0.4				}),-- -- --"Text")			})
--
--
--		end
--
...
--
--
--function-- -- --OrionLib:Destroy()	Orion:Destroy()
--
--
--end
--
